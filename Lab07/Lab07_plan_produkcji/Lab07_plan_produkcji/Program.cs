...
namespace ASD
{
    public class SimpleProductionProfitTestCase : TestCase
    {
        ...
        public SimpleProductionProfitTestCase(double timeLimit, Exception expectedException, string description,
            (PlanData[], PlanData[], PlanData) inputData, int expectedMaxProduction, double expectedMaxProfit) : base(
            timeLimit, expectedException, description)
        {
        ...
        {
            var simpleProductionPlan =
                ((ProductionPlanner)prototypeObject).CreateSimplePlan(production, sales, storageInfo, out _);
        ...
        protected override (Result resultCode, string message) VerifyTestCase(object settings)
        {
            ...
            if (actualMaxProduction != expectedMaxProduction)
            {
                ...
                message =
                    $"Wrong number of units produced: expected {expectedMaxProduction}, got {actualMaxProduction}";
    ...
    public class SimpleProductionPlanTestCase : TestCase
    {
        ...
        protected override (Result resultCode, string message) VerifyTestCase(object settings)
        {
            ...
            if (weeks != weeklyPlan.Length)
            {
                resultCode = Result.WrongResult;
                message =
                    $"Bad plan - wrong number of weeks; expected {weeks} weeks, WeeklyPlan has length {weeklyPlan.Length}";
                return (resultCode, message);
            }
    ...
    public class ComplexProductionProfitTestCase : TestCase
    {
        ...
        public ComplexProductionProfitTestCase(double timeLimit, Exception expectedException, string description,
            (PlanData[], PlanData[,], PlanData) inputData, int expectedMaxProduction, double expectedMaxProfit) : base(
            timeLimit, expectedException, description)
        {
            (production, sales, storageInfo) = inputData;
        ...
        {
            var productionPlan =
                ((ProductionPlanner)prototypeObject).CreateComplexPlan(production, sales, storageInfo, out _);
        ...
        protected override (Result resultCode, string message) VerifyTestCase(object settings)
        {
            ...
            for (int i = 0; i < weeks; ++i)
            {
                ...
                if (planStep.UnitsSold.Length != customers)
                {
                    resultCode = Result.WrongResult;
                    message =
                        $"Bad plan - UnitsSold array in week {i} has invalid length; expected {customers}, got {planStep.UnitsSold.Length}";
                    return (resultCode, message);
                }
    ...
    public static class ComplexTests
    {
        ...
        public static (PlanData[], PlanData[,], PlanData) FreeStorage()
        {
            ...
            for (int week = 0; week < productionInfo.Length; ++week)
            {
                ...
                {
                    salesInfo[customer, week] = new PlanData
                        { Quantity = demand, Value = cost - 5 + (week == 4 ? 25 : 0) };
                }
            }
    ...
    public class Lab11TestModule : TestModule
    {
        public override void PrepareTestSets()
        {
            ...
            simpleProfitTests.TestCases.AddRange(new List<TestCase>
            {
                ...
                new SimpleProductionProfitTestCase(20, null, "Mały test - większy zysk z magazynem",
                    SimpleTests.SmallTestWithStorageProfit(), 45, 50.0),
                new SimpleProductionProfitTestCase(20, null, "Wąskie gardło - popyt", SimpleTests.DemandBottleneck(),
                    75, 200.0),
                new SimpleProductionProfitTestCase(20, null, "Wąskie gardło - podaż", SimpleTests.SupplyBottleneck(),
                    35, 50.0),
                ...
                new SimpleProductionProfitTestCase(20, null, "Średni test losowy", SimpleTests.RandomTest(100, 42),
                    40233, 220922.0),
                new SimpleProductionProfitTestCase(20, null, "Duży test losowy", SimpleTests.RandomTest(150, 1337),
                    57375, 504271.0),
            });
            ...
            simplePlanTests.TestCases.AddRange(new List<TestCase>
            {
                ...
                new SimpleProductionPlanTestCase(20, null, "Mały test - większy zysk z magazynem",
                    SimpleTests.SmallTestWithStorageProfit(), 45, 50.0),
                new SimpleProductionPlanTestCase(20, null, "Wąskie gardło - popyt", SimpleTests.DemandBottleneck(), 75,
                    200.0),
                new SimpleProductionPlanTestCase(20, null, "Wąskie gardło - podaż", SimpleTests.SupplyBottleneck(), 35,
                    50.0),
                ...
                new SimpleProductionPlanTestCase(20, null, "Średni test losowy", SimpleTests.RandomTest(100, 42), 40233,
                    220922.0),
                new SimpleProductionPlanTestCase(20, null, "Duży test losowy", SimpleTests.RandomTest(150, 1337), 57375,
                    504271.0),
            });
            ...
            complexProfitTests.TestCases.AddRange(new List<TestCase>
            {
                ...
                new ComplexProductionProfitTestCase(20, null, "Mały test - większy zysk z magazynem",
                    ComplexTests.SmallTestWithStorageProfit(), 25, 29.0),
                new ComplexProductionProfitTestCase(20, null, "Wąskie gardło - popyt", ComplexTests.DemandBottleneck(),
                    51, 69.0),
                new ComplexProductionProfitTestCase(20, null, "Wąskie gardło - podaż", ComplexTests.SupplyBottleneck(),
                    85, 652.0),
                new ComplexProductionProfitTestCase(20, null, "Darmowy magazyn", ComplexTests.FreeStorage(), 72,
                    1860.0),
                ...
                new ComplexProductionProfitTestCase(20, null, "Średni test losowy",
                    ComplexTests.RandomTest(30, 10, 11111), 9862, 227625.0),
                new ComplexProductionProfitTestCase(20, null, "Duży test losowy",
                    ComplexTests.RandomTest(45, 15, 22222), 16304, 532936.0),
            });
            ...
            complexPlanTests.TestCases.AddRange(new List<TestCase>
            {
                ...
                new ComplexProductionPlanTestCase(20, null, "Mały test - większy zysk z magazynem",
                    ComplexTests.SmallTestWithStorageProfit(), 25, 29.0),
                new ComplexProductionPlanTestCase(20, null, "Wąskie gardło - popyt", ComplexTests.DemandBottleneck(),
                    51, 69.0),
                new ComplexProductionPlanTestCase(20, null, "Wąskie gardło - podaż", ComplexTests.SupplyBottleneck(),
                    85, 652.0),
                ...
                new ComplexProductionPlanTestCase(20, null, "Średni test losowy",
                    ComplexTests.RandomTest(30, 10, 11111), 9862, 227625.0),
                new ComplexProductionPlanTestCase(20, null, "Duży test losowy", ComplexTests.RandomTest(45, 15, 22222),
                    16304, 532936.0),
            });
